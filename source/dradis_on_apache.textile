...
You can either <a href="download.html">download</a> the latest release or checkout the latest and greatest version from the <a href="subversion.html">subversion</a> repository.
...
This will initialize the production SQLite3 database (~/dradis/server/db/production.sqlite3). You can use other engines like MySQLor Postgres. See the <a href="configure.html">configuration</a> page for more details on how to do this.
...
If for some reason this doesn't work, remember to check out the logs in the <code>log/</code> folder in the directory you uncompressed Dradis and feel free to ask in the <a href="/community/">forums</a> or the <a href="mailing_lists.html">mailing list</a>.
